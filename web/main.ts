    ...
    if (this.loadViewTo !== null && this.currentRepo === this.loadViewTo.repo) {
      if (
        ...
        if (commitElem !== null && (this.loadViewTo.commitDetails.compareWithHash === null || compareWithElem !== null)) {
          ...
          showErrorMessage(
            "Unable to resume Code Review, it could not be found in the latest " + this.maxCommits + " commits that were loaded in this repository.",
          );
        }
...
function generateFileTreeLeafHtml(
  ...
  if (leaf.type === "file") {
    ...
    return (
      ...
      '" title="' +
      (diffPossible ? "Click to View Diff" : "Unable to View Diff" + (fileTreeFile.type !== GG.GitFileStatus.Deleted ? " (this is a binary file)" : "")) +
      " • " +
      changeTypeMessage +
